...
def measure_tflops_flashinfer_paged_decode(seq_len, config, bs, page_size=16):
    ...
    total_bytes = 2 * h_kv * seq_len * d_h + 2 * h_qo * d_h
    tflops = total_flop / elapsed_time / 1e12
    tbytes = total_bytes / elapsed_time / 1e9
...
fig.suptitle('Decode Memory Utilization by Page Size', fontsize=16)
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('assignment3/Section2/viz/memory_decode_attention_by_page_size.png', dpi=300)