...
fig.suptitle('Decode Compute Utilization by Sequence Length', fontsize=16)
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.savefig('assignment3/Section2/viz/decode_attention_by_sequence_length.png', dpi=300)